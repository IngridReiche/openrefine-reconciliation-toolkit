...
class SearchLoC:
    ...
    def did_you_mean(self):
        ...
        return [(child.text, child.attrib.get('uri')) for child in iter(tree) if child.attrib.get('uri')]
        # return [(child.text, child.attrib['uri']) for child in iter(tree)] - this was the orignal code replace with line 98
